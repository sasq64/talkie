...
class AdventureGuy:
    ...
    def set_output(self, text: str):
        self.client.clear()
        self.client.add_line(
            f"Here follows the output of an interpreter of interactive fiction (text adventure). Identify the *descriptive* story parts of the text that can be read to the player as audio. Strip out technical information and information about scores and moves. Call 'set_verbal_text' with the result. The output:\n```\n{text}\n```\n"
        )
