...
void bitmap_st2_name(int num, const char* dir, char* out)
{
	/* title picture is #30 */
	if (num == 0)
		num = 30;
...
void bitmap_pc_name(int num, const char* dir, char* out)
{
	/* title picture is #30 */
	if (num == 0)
		num = 30;
...
void bitmap_noext_name(int num, const char* dir, char* out)
{
	if (num == 0)
	{
		FILE* f;
...
void bitmap_c64_name(int num, const char* dir, char* out)
{
	if (num == 0)
...
void bitmap_bbc_name(int num, const char* dir, char* out)
{
	FILE* f;
...
void bitmap_cpc_name(int num, const char* dir, char* out)
{
	if (num == 0)
...
BitmapType DetectBitmaps(const char* dir)
{
	char file[MAX_PATH];
...
Bitmap* DecodeBitmap(const char* dir, BitmapType type, int num, int x, int y)
{
	char file[MAX_PATH];
