...
*
* Parameters:   int8_t* name            zero terminated string of filename
*                                       typed by player
*               uint8_t*  ptr             pointer to data to save
*               uint16_t size             number of bytes to save
*
...
*
* Parameters:   uint8_t   c               character to be printed
*
...
*
* Parameters:   uint8_t   trans           if not 0, translate any #undo
...
*
* Parameter:    uint32_t  c       number of image to be displayed
*               uint8_t   mode    mode == 0 means gfx off,
...
*
* Parameters:   uint32_t  c               number of the picture
*               uint16_t* w               width of picture
*               uint16_t* h               height pf picture
*               uint16_t* pal             array for the palette (16 colours)
*               uint8_t*  is_anim         1 if animated picture, otherwise 0
*                                       OR null (!)
*
...
* are animations. To detect these, pass a pointer to a uint8_t as the is_anim
...
*
* Parameters:   int16_t   number        number of frame (see ms_position struct)
*               uint16_t*   width         width of frame
*               uint16_t*   height        height of frame
*               uint8_t**   mask          pointer to masking data, might be NULL
*
* Return: 1 if animation continues, 0 if animation is finfished
*
...
*
* Parameter:    uint8_t * midi_data       the MIDI data to play
*               uint32_t  length          the length of the MIDI data
*               uint16_t  tempo           the suggested tempo for playing
*
...
*
* Parameters:   int8_t* name            filename of story file
*               int8_t* gfxname         filename of graphics file (optional)
*               int8_t* hntname         filename of hints file (optional)
*               int8_t* sndname         filename of music file (optional)
*
* Return:       0 = failure
